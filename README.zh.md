...
```
┌─────────────────────────────────────────────────────────────────┐
│  应用层：Next.js Web · Flutter Mobile · Gas Station · Indexer    │
├─────────────────────────────────────────────────────────────────┤
│  业务模块层                                                      │
│  ┌──────────────────────┐    ┌────────────────────────────┐    │
...
| 链下服务 | `services/` | Gas Station、Indexer、LP Guard、Oracle Relayer 等 |
...
│   ├── gas-station/          # Gas 赞助（Prophet 白名单 PTB）
...
| 服务 | 端口 | 说明 |
| --- | --- | --- |
| Gas Station | 8787 | Prophet 免费 Commit Gas 赞助 |
...
- [docs/gas-station-implementation.zh.md](./docs/gas-station-implementation.zh.md)
