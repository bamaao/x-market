...
**简体中文** | [English](./mainnet-infra-priority.md)

# X-Market Sui 主网基础设施优先级清单

> **版本：** v1.0 · **日期：** 2026-06-06  
> **关联：** [mainnet-readiness-checklist.zh.md](./mainnet-readiness-checklist.zh.md) · [mainnet-governance-params.zh.md](./mainnet-governance-params.zh.md) · [phase4-services.zh.md](./phase4-services.zh.md)
...
详见 [services-testnet-runbook.zh.md](./services-testnet-runbook.zh.md)。主网须将密钥迁入 KMS/HSM 后复用同一流程。
...
| # | 项 | 状态 | 工期 | 说明 |
|---|-----|------|------|------|
| 1.1 | 可观测性与告警 | [x] | 3–5 天 | `services/chain-monitor`：`/health` `/metrics` `/alerts`；见 [p1-services-runbook.zh.md](./p1-services-runbook.zh.md) |
| 1.2 | Oracle 运营 Runbook + 排班 | [x] | 1 天 | [oracle-oncall-schedule.zh.md](./oracle-oncall-schedule.zh.md) + [oracle-playbook.zh.md](./oracle-playbook.zh.md) |
...
| # | 项 | 状态 | 工期 | 说明 |
|---|-----|------|------|------|
| 2.1 | Indexer（完整） | [x] | 2–3 周 | `services/indexer` + Postgres；见 [p2-indexer-runbook.zh.md](./p2-indexer-runbook.zh.md) |
...
| 3.4 | GeoBlock / 合规 | [x] | `middleware.ts` + [compliance-geoblock.zh.md](./compliance-geoblock.zh.md) |
...
详见 [p4-scale-runbook.zh.md](./p4-scale-runbook.zh.md)。
