...
**简体中文** | [English](./business-spec.md)

# X-Market Sui 业务规格文档

> **版本：** v1.1 · **日期：** 2026-06-11  
> **状态：** 草案  
> **关联：** [PRD.zh.md](../PRD.zh.md) · [test-cases.zh.md](./test-cases.zh.md) · [demo-walkthrough.zh.md](./demo-walkthrough.zh.md)
...
本文从 **业务事件 → 业务流程 → 用例 → 交互（界面 / 事件 / 时序）** 四层整理 X-Market on Sui 产品体系的业务规格，供产品、研发、运维与审计对齐语义。测试用例与自动化映射见 [test-cases.zh.md](./test-cases.zh.md)。
...
> 详见 [PRD §11](../PRD.zh.md#11-suiprophet-network知识付费模块) · [prophet-playbook.zh.md](./prophet-playbook.zh.md)
...
用例按业务流程分组；交互事件编号 `E-xx.y.z` 与 [test-cases.zh.md](./test-cases.zh.md) 一致。
...
| 文档 | 关系 |
| --- | --- |
| [test-cases.zh.md](./test-cases.zh.md) | 同编号体系的 **测试用例**（TC-xx.y.z） |
| [PRD.zh.md](../PRD.zh.md) | 产品需求与 Phase 规划 |
| [demo-walkthrough.zh.md](./demo-walkthrough.zh.md) | 路演演示路线 |
| [oracle-playbook.zh.md](./oracle-playbook.zh.md) | Oracle 运维 |
| [prophet-playbook.zh.md](./prophet-playbook.zh.md) | Prophet 运维 |
| [prophet-market-and-encryption-guide.zh.md](./prophet-market-and-encryption-guide.zh.md) | 创建市场 + 公开/加密预测操作指南 |
...
| 日期 | 版本 | 说明 |
| --- | --- | --- |
| 2026-06-12 | v1.2 | 新增 [prophet-market-and-encryption-guide.zh.md](./prophet-market-and-encryption-guide.zh.md)：创建市场与加密预测操作指南 |
