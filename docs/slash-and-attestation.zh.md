...
**简体中文** | [English](./slash-and-attestation.md)

# Slash 与 Attestation 概念说明

> **版本：** v1.2 · **日期：** 2026-06-08  
> **状态：** 概念文档（与链上实现一致）  
> **关联：** [tier2-decision.zh.md](./tier2-decision.zh.md) · [phase3-playbook.zh.md](./phase3-playbook.zh.md) · [mainnet-governance-params.zh.md](./mainnet-governance-params.zh.md)
...
**产品决议（[tier2-decision.zh.md](./tier2-decision.zh.md)）：** 主路径不依赖 Attestation/ZK；`zk_coprocessor` 为可选监督层，Tier 2 联合 PDF 尚未接入 `buy_*`。

### 1.6 治理参数

见 [mainnet-governance-params.zh.md](./mainnet-governance-params.zh.md) §3：
...
见 [mainnet-governance-params.zh.md](./mainnet-governance-params.zh.md) §2：
...
**[tier2-decision.zh.md](./tier2-decision.zh.md) §5 原意：**
...
详见 [phase3-playbook.zh.md](./phase3-playbook.zh.md) §4：
...
详见 [phase3-playbook.zh.md](./phase3-playbook.zh.md) §5、[mainnet-drill-2026-06-06.zh.md](./mainnet-drill-2026-06-06.zh.md) 演练 B/C：
