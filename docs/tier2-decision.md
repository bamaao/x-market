...
> **状态：** 已决议  
> **关联：** [PRD.md](../PRD.md) §3.6 · [math-spec/SPEC.md](../math-spec/SPEC.md) §9 · [docs/qa.md](./qa.md) §Tier 1/2 · [phase3-playbook.md](./phase3-playbook.md) §4 · [deferred-features.md](./deferred-features.md)
...
- **Attestation + 挑战约束**：性能满足热路径登记；信任依赖验证委员会 + slash（与 Macro Oracle 同类模型）
